"""
Combined free-frequency figure.

Layout
------
Left (stacked, shared x-axis):
  Top    — Re(ω_fit) vs t0 with horizontal reference lines
  Bottom — κ_fit     vs t0 with horizontal reference lines

Right (square panel):
  Complex-plane scatter (Re ω, κ) coloured by t0, with DW star and QNM markers.

All three panels share the same plasma colormap / colorbar for t0.
